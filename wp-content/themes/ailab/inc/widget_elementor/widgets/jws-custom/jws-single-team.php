                    ...
                    echo '<div>';
                        ...
                        foreach ( (array) $social_medias as $key => $item ) {
                                ...
                                if ( isset( $item['social_media_icon_name'] ) ) {
                                    	echo '<a href="'. $item['social_media_link'] .'"><i class="'. $item['social_media_icon_name'] .' slide-icon"></i></a>';
                            	}
                        }
                        echo '</div>';
                        echo '<div class="elementor-slide-description">' . wp_trim_words( get_the_excerpt(), 50 , '...' ) . '</div>';
						echo '<div class="elementor-slide-your_name">' . get_the_title() . '</div>';
                        if ( get_post_meta( get_the_ID(), 'postion', 1 ) ) {
                            echo  '<div class="elementor-slide-tag">' . get_post_meta( get_the_ID(), 'postion', 1 ) . '</div>'; 
                        }
                    echo '</div>';
				echo '</div>';
			echo '</div>';
