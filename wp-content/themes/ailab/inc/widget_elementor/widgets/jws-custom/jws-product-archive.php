...
class ProductArchive extends Widget_Base {
	...
	public function get_title() {
		return __( 'Jws-product-archive', 'ailab' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Sale, Featured, New', 'ailab' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Background Color Sale', 'ailab' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Background Color Featured', 'ailab' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Background Color New', 'ailab' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
	...
	protected function render() {
        ...
        <div class="added_to_cart_message"></div>
		<?php
	}
