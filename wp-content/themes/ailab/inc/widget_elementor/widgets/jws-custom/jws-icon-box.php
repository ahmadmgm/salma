 ...
 * @since 1.0.0
 */
class JWS_Icon_Box extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'default' => __( 'Default', 'ailab' ),
					'stacked' => __( 'Stacked', 'ailab' ),
					'framed' => __( 'Framed', 'ailab' ),
				],
				'default' => 'default',
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'This is the heading', 'ailab' ),
				'placeholder' => __( 'Enter your title', 'ailab' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'ailab' ),
				'placeholder' => __( 'Enter your description', 'ailab' ),
				'rows' => 10,
				'separator' => 'none',
				'show_label' => false,
			]
		...
		$this->add_control(
			'secondary_color',
			[
				'label' => __( 'Secondary Color', 'ailab' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'condition' => [
					'view!' => 'default',
		...
		$this->add_control(
			...
			[
				'label' => __( 'Vertical Alignment', 'ailab' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'top' => __( 'Top', 'ailab' ),
					'middle' => __( 'Middle', 'ailab' ),
	...
	protected function render() {
		...
		<div class="elementor-icon-box-wrapper jws-icon-box">
			<?php if ( $has_icon ) : ?>
			<div class="elementor-icon-box-icon <?php if ($settings['background_gradient']) { echo esc_attr('background-gradient');} ?>">
	...
	protected function content_template() {
		...
		<div class="elementor-icon-box-wrapper jws-icon-box">
			...
			<div class="elementor-icon-box-icon <# if (settings.background_gradient) {#> background-gradient <# } #>">
