...
class PostRecent extends Widget_Base {
	...
	public function get_title() {
		return __( 'Jws-post-recent', 'ailab' );
	}
	...
	protected function render() {
        ...
        foreach($recent_posts as $post) : ?>
            <div class="col-<?php echo esc_attr($settings['columns_mobile']) ?> col-lg-<?php echo esc_attr($settings['columns_tablet']) ?> col-xl-<?php echo esc_attr($settings['columns']) ?>">
                <a href="<?php echo esc_attr(get_permalink($post['ID']))  ?>">
                    <?php echo esc_attr(get_the_post_thumbnail($post['ID'], 'full')); ?>
                    <p class="slider-caption-class"><?php echo esc_html($post['post_title']) ?></p>
    ...
    protected function render_category() {
		...
		?>
			<p class="studies-category"><?php echo esc_html(get_the_term_list(get_the_ID(), 'studies_cat', '&nbsp &nbsp')); ?></p>
		<?php
	}
	...
	protected function render_excerpt() {
		...
		?>
		<div class="studies-decription"><?php echo esc_html(wp_trim_words( get_the_excerpt(), $settings['studiess_per_words'] , '...' )) ?></div>
		<?php
	}
	...
	protected function render_button() {
		...
		<div class="studies-link">
			<a href="<?php the_permalink() ?>">
				<span class="studies-link__text" ><?php echo esc_attr($settings['text']); ?>
