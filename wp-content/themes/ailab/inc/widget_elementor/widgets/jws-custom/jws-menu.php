	...
	*/
	protected function register_content_nav_menu_controls() {
		...
		$this->start_controls_section(
         ...
         $this->add_control(
			...
			[
				...
				'options' => [
					'menu_horizontal' => __( 'Horizontal Menu', 'ailab' ),
                    'menu_vertical' => __( 'Vertical Menu', 'ailab' ),
				],
		...
		if ( ! empty( $menus ) ) {
			...
			$this->add_control(
				...
				[
					...
					'raw' => '<strong>' . __( 'There are no menus in your site.', 'ailab' ) . '</strong><br>' . sprintf( __( 'Go to the <a href="%s" target="_blank">Menus screen</a> to create one.', 'ailab' ), admin_url( 'nav-menus.php?action=edit&menu=0' ) ),
					'separator' => 'after',
        ...
        $this->add_control(
			'skins',
			[
				'label' => __( 'Skins', 'ailab' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'skin1' => __( 'skin 1', 'ailab' ),
                    'skin2' => __( 'skin 2', 'ailab' ),
				],
				'default' => 'skin1',
          ...
          $this->add_control(
			'before_menu_item',
			[
				'label' => __( 'Before Menu Item', 'ailab' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'none' => __( 'None', 'ailab' ),
                    'circle' => __( 'Circle', 'ailab' ),
                    'square' => __( 'Square', 'ailab' ),
				],
				'default' => 'none',
	...
	*/
	...
	protected function register_style_nav_controls() {
        ...
        $this->add_control(
					...
					[
						'label' 	=> __( 'Before Item Color', 'ailab' ),
						'type' 		=> Controls_Manager::COLOR,
						'default' 	=> '',
						'selectors' => [
	...
	protected function register_style_sub_menu_controls() {
		...
		'sub_item_style',
			[
				...
				'label' => __( 'Item Font And Color', 'ailab' ),
				'separator' => 'before',
			]
		);
        $this->add_responsive_control(
        ...
        $this->add_control(
					...
					[
						'label' 	=> __( 'Background EVEN AND ODD', 'ailab' ),
						'type' 		=> Controls_Manager::COLOR,
						'default' 	=> '',
						'selectors' => [
	...
	protected function register_style_sub_mega_controls() {
        ...
        $this->add_group_control(
				...
				[
					...
					'label' 	=> __( 'Sub Mega Border', 'ailab' ),
	...
	protected function render() {
        ...
        $attr = array(
         ...
         ?>
             <div class="jws_main_menu<?php echo esc_attr(' sub_skin_'.$settings['sub_skins']) ; ?>">    
