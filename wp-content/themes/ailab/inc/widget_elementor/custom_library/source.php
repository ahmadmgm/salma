...
class Source_Custom extends Source_Base {
	 ...
	 */
	const LIBRARY_OPTION_KEY = 'custom2_remote_info_library';

	/**
	 * Timestamp cache key to trigger library sync.
	 */
	const TIMESTAMP_CACHE_KEY = 'custom2_remote_update_timestamp';
	 ...
	 */
	public static $api_info_url = 'http://ailab.jwsuperthemes.com/wp-content/templates-kit/index.json';
	 ...
	 */
	private static $api_get_template_content_url = 'http://ailab.jwsuperthemes.com/wp-content/templates-kit/file/%d.json';
