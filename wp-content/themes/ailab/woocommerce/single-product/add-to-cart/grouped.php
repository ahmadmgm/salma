				...
				foreach ( $grouped_product_columns as $column_id ) {
					...
					switch ( $column_id ) {
						...
						case 'image':
							...
							$value .= $grouped_product_child->is_visible() ? '<a href="' . esc_url( apply_filters( 'woocommerce_grouped_product_list_link', $grouped_product_child->get_permalink(), $grouped_product_child->get_id() ) ) . '">' . $grouped_product_child->get_image('woocommerce_thumbnail') . '</a>' : $grouped_product_child->get_image('woocommerce_thumbnail');
							$value .= '</div>';
							break;
						case 'price':
