...
if ( ! defined( 'ABSPATH' ) ) {
    ...
    function jws_register_teams() {
		$labels = array(
			'name'                => _x( 'teams', 'Post Type General Name', 'ailab' ),
			'singular_name'       => _x( 'teams', 'Post Type Singular Name', 'ailab' ),
			'menu_name'           => esc_html__( 'Teams', 'ailab' ),
		...
		$labels = array(
			'name'					=> _x( 'teams Categories', 'Taxonomy plural name', 'ailab' ),
			'singular_name'			=> _x( 'teams Category', 'Taxonomy singular name', 'ailab' ),
			'search_items'			=> esc_html__( 'Search Categories', 'ailab' ),
			'popular_items'			=> esc_html__( 'Popular teams Categories', 'ailab' ),
			'all_items'				=> esc_html__( 'All teams Categories', 'ailab' ),
